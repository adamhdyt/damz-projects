...
const navItems: { id: Section; label: string; icon: typeof Home; hint: string }[] = [
  { id: "home", label: "Home", icon: Home, hint: "Everything" },
  { id: "tech", label: "Tech Notes", icon: Code2, hint: "Engineering" },
  { id: "life", label: "Life", icon: Coffee, hint: "Personal" },
]
