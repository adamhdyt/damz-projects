...
const sectionMeta: Record<Section, { title: string; description: string }> = {
  home: {
    ...
    description: "Engineering deep-dives and honest reflections, all in one place.",
  },
  tech: {
    title: "Tech Notes",
...
export function MainContent({
  ...
  const filtered =
    active === "home" ? posts : posts.filter((p) => p.category === active)
